...
export const Route = createFileRoute("/hot-water-recirculation-pumps")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Hot water recirculation pump installation in Brownwood, TX. Instant hot water at every faucet — save water and time. Call (325) 641-2662." },

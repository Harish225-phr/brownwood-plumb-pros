...
export const Route = createFileRoute("/residential-plumbing")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Trusted residential plumber in Brownwood, TX. Home repairs, repipes, fixtures, water heaters & more. 35+ years experience. Call (325) 641-2662." },

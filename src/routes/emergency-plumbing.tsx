...
export const Route = createFileRoute("/emergency-plumbing")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "24-hour emergency plumber in Brownwood, TX for burst pipes, major leaks, water line emergencies and overflowing fixtures. Call (325) 641-2662 any time." },
      ...
      <ServicePageShell
        ...
        body={
          <>
            ...
            <p>If you're dealing with an active leak right now: shut off the main water valve to your home (usually near the street or in a utility area), move valuables away from the water, and call us at <strong>(325) 641-2662</strong>. We'll be on our way.</p>
          </>
        }
      />

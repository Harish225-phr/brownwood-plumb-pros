...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Top-rated plumber in Brownwood, TX with 35+ years of experience. Residential, commercial & 24-hour emergency plumbing. Call (325) 641-2662 for fast service." },
      { property: "og:title", content: "Plumber in Brownwood, TX | M. Webb Plumbing Co." },
      { property: "og:description", content: "35+ years of trusted plumbing service in Brownwood, Early, Bangs, Lake Brownwood & Zephyr, TX. 24-hour emergency. Call (325) 641-2662." },
...
const faqs = [
  ...
  { q: "How much does a plumbing repair cost?", a: "Pricing depends on the issue. We give honest, upfront estimates before any work begins — no surprises. Call (325) 641-2662 for a free estimate." },
];

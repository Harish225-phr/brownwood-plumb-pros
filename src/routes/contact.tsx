...
export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Contact M. Webb Plumbing Co. in Brownwood, TX. Call (325) 641-2662, email webbplumbing@verizon.net, or request a free estimate online." },

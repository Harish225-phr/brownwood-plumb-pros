      ...
      <ServicePageShell
        ...
        body={
          <>
            ...
            <p>Need a commercial plumber across <strong>Brownwood, Early, Bangs, Lake Brownwood or Zephyr, TX</strong>? Call <strong>(325) 641-2662</strong> for fast, professional service.</p>
          </>
        }
      />
      <CTABanner />

...
export const Route = createFileRoute("/leak-detection")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Expert leak detection in Brownwood, TX. Find and fix hidden water leaks fast before they cause expensive damage. Call (325) 641-2662." },
